...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      },
      {
        ...
        loader: ExtractTextPlugin.extract(
          "style-loader",
          "css-loader?minimize&-autoprefixer!postcss-loader!sass-loader"
        )
      },
      {
      ...
      {
        test: require.resolve("./src/js/lib/ajax"), //根据不用的环境来改变js变量（ajaxHost）的值；
        loader: "imports-loader?ajaxHost=>" + JSON.stringify("/ci")
      }
    ],
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      //Tell Webpack to use Node's production environment
      "process.env": {
