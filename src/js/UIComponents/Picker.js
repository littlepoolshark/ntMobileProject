...
export default class Picker extends Component {
  ...
  render() {
    ...
    let pickerModalContainerClass=classNames(
        "picker-modal-container",
        {
          "picker-modal-isOpen":isOpen
        }
      );


    return (
      <div className={pickerModalContainerClass}>
        <div className="picker-modal-mask" onClick={this._closePicker}></div>
        <div className="picker-modal">
          <div className="picker-header">
              <a href="javascript:void(0)" onClick={this._closePicker}>取消</a>
              <a href="javascript:void(0)" onClick={this._handleConfirm}>确定</a>
          </div>
