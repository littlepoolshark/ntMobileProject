require("../../scss/page/CEDLoanIntroduction.scss");
let CEDLoanIntroductionAction = require("../actions/CEDLoanIntroductionAction.js");
let CEDLoanIntroductionStore = require("../stores/CEDLoanIntroductionStore.js");
...
let CEDLoanIntroduction = React.createClass({
  getInitialState() {
    return {
      data: CEDLoanIntroductionStore.getAll(),
      isMaskOpen: false,
      maskType: "descriptionOfCreditor"
    };
  },
  _handleOnScroll(event) {
    let container = document.getElementById("CEDLoanIntroduction");
            ...
            <Tabs defaultActiveKey={0}>
              <Tabs.Item title="项目信息" key={0} navStyle={null}>
                <Group noPadded={false}>
                  ...
                  <div className="content">
                    “车e贷”为饭米粒理财根据投资方20年经营大数据严格筛选的优质借款人借款需求，每一个项目都经过现场勘查，并提供第三方担保人实力担保，对于贷后资金管理亦建立了一套严谨的监控体系，确保资金安全。
                  </div>
                </Group>
                <Group noPadded={false}>
                  <h6>
  ...
  componentDidMount() {
    ...
    CEDLoanIntroductionAction.getDataFromServer(id);

    CEDLoanIntroductionStore.bind(
      "change",
      function() {
        this.setState(CEDLoanIntroductionStore.getAll());
      }.bind(this)
    );
...
CEDLoanIntroduction.contextTypes = {
  router: React.PropTypes.object.isRequired
};

module.exports = CEDLoanIntroduction;
