...
MicroEvent.mixin(CEDLoanIntroduction);

appDispatcher.register(function(payload) {
  switch (payload.actionName) {
    case "cedLoanIntroduction_getDataFromServer":
      ajax({
        ...
        success: function(rs) {
          if (rs.code === 0) {
            ...
            CEDLoanIntroduction.updateAll(
              CEDLoanIntroduction.processData(source)
            );
            CEDLoanIntroduction.trigger("change");
            ...
            ajax({
              ...
              success: function(rs) {
                if (rs.code === 0) {
                  CEDLoanIntroduction.extractLicenseListAndUpdate(rs.data.list);
                  CEDLoanIntroduction.trigger("change");
                }
              }
            });
            ...
            ajax({
              ...
              success: function(rs) {
                if (rs.code === 0) {
                  CEDLoanIntroduction.extractGuaranteeLicenseListAndUpdate(
                    rs.data
                  );
                  CEDLoanIntroduction.trigger("change");
                }
            ...
            CEDLoanIntroduction.trigger("getDataFailed");
          }
        }
      });
      //获取标的借款人信息
