...
MicroEvent.mixin(DljLoanIntroductionStore);

appDispatcher.register(function(payload) {
  switch (payload.actionName) {
    case "gljLoanIntroduction_getDataFromServer":
      ajax({
        ...
        success: function(rs) {
          if (rs.code === 0) {
            ...
            DljLoanIntroductionStore.updateAll(
              DljLoanIntroductionStore.processData(source)
            );
            DljLoanIntroductionStore.trigger("change");
            ...
            ajax({
              ...
              success: function(rs) {
                if (rs.code === 0) {
                  DljLoanIntroductionStore.extractLicenseListAndUpdate(
                    rs.data.list
                  );
                  DljLoanIntroductionStore.trigger("change");
                }
            ...
            ajax({
              ...
              success: function(rs) {
                if (rs.code === 0) {
                  DljLoanIntroductionStore.extractGuaranteeLicenseListAndUpdate(
                    rs.data
                  );
                  DljLoanIntroductionStore.trigger("change");
                }
            ...
            DljLoanIntroductionStore.trigger("getDataFailed");
          }
        }
      });
      //获取标的借款人信息
...
module.exports = DljLoanIntroductionStore;
